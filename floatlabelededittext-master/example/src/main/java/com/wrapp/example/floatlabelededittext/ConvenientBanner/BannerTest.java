package com.wrapp.example.floatlabelededittext.ConvenientBanner;
 ...
 */
public class BannerTest extends ActionBarActivity implements AdapterView.OnItemClickListener, ViewPager.OnPageChangeListener, OnItemClickListener {
    private ConvenientBanner convenientBanner;//顶部广告栏控件
    private ArrayList<Integer> localImages = new ArrayList<Integer>();
    private List<String> networkImages;
    private String[] images = {"https://raw.githubusercontent.com/zzzengxiaoxian/MyApp/master/photo/1.jpg",
            "https://raw.githubusercontent.com/zzzengxiaoxian/MyApp/master/photo/11.jpg",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twofragment_activity);
        initViews();
        init();
    }
